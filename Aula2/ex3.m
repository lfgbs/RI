...
arrow1=patch('XData', A(1,:) ,'YData', A(2,:),'ZData', A(3,:))
arrow2=patch('XData', A(1,:) ,'YData', A(2,:),'ZData', A(3,:))
arrow3=patch('XData', A(1,:) ,'YData', A(2,:),'ZData', A(3,:))
...
%animate rotation yy
for elem=array
    nGeomA1 = roty((pi/2)*elem)
    transformationA1=nGeom*A
